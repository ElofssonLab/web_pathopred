#cython: cdivision=True, boundscheck=False, wraparound=True, embedsignature=True, language_level=2
...
def main():
    ...
    for fasta in pbar:
            ...
            new_fasta = fasta.replace('ur50.fasta', 'ur90.fasta')
            os.system('vmtouch -qt {} &'.format(new_fasta))
            self_info, part_entr, seq = process_fasta(new_fasta)
            os.system('vmtouch -et {} &'.format(new_fasta))
